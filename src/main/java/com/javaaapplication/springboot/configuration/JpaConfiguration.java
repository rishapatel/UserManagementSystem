...
@Configuration
@EnableJpaRepositories(basePackages = "com.javaaapplication.springboot.repositories",
...
public class JpaConfiguration {
	 ...
	 @Autowired
	    ...
	    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
	        ...
	        factoryBean.setPackagesToScan(new String[] { "com.javaaapplication.springboot.model" });
