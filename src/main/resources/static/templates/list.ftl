                ...
                <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.user.name" id="uname" class="username form-control input-sm" 
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-md-2 control-lable" for="emailaddress">EmailAddress</label>
                            <div class="col-md-7">
                                <input type="email" ng-model="ctrl.user.emailaddress"
                                 id="emailaddress" class="form-control input-sm" placeholder="Enter your EmailAddress." required ng-pattern="ctrl.String"/>
                            </div>
                        </div>
                    </div>
